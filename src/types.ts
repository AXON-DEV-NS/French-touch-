...
export const TRANSLATIONS = {
  ar: {
    ...
    categories: {
      sandwiches: 'السندوتشات الفاخرة',
      fries: 'بطاطس فرنش تاتش',
      desserts: 'الحلويات اللذيذة',
  ...
  fr: {
    ...
    categories: {
      sandwiches: 'Sandwiches Fins',
      fries: 'Frites Croustillantes',
  ...
  it: {
    ...
    categories: {
      sandwiches: 'Panini Gourmet',
      fries: 'Patatine Croccanti',
      desserts: 'Dolci Deliziosi',
